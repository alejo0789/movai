...
const MovAIEnhancedLanding = () => {
  ...
  return (
    ...
    <div className="hidden md:flex space-x-6 items-center">
      <a href="/" className="font-medium text-blue-400 transition-all duration-300">
        Inicio
      </a>
      <a href="#soluciones" className="font-medium text-gray-300 hover:text-white transition-all duration-300">
        Soluciones
      </a>
      <a href="#tecnologia" className="font-medium text-gray-300 hover:text-white transition-all duration-300">
        Tecnología
      </a>
      
      {/* Dropdown de Políticas */}
      <div className="relative group">
        <button className="font-medium text-gray-300 hover:text-white transition-all duration-300 flex items-center">
          Políticas
        ...
        {/* Dropdown Menu */}
        <div className="absolute left-0 mt-2 w-56 bg-gray-900 rounded-lg shadow-lg border border-gray-800 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300">
          <a 
            href="/policies" 
            className="block px-4 py-3 text-gray-300 hover:bg-gray-800 hover:text-white transition-colors rounded-t-lg"
          >
            📋 Política de Privacidad
          </a>
          <a 
            href="/policies-whatsapp" 
            className="block px-4 py-3 text-gray-300 hover:bg-gray-800 hover:text-white transition-colors rounded-b-lg"
          >
            💬 Política WhatsApp
          </a>
        </div>
      ...
      <a href="#contacto" className="font-medium text-gray-300 hover:text-white transition-all duration-300">
        Contacto
      </a>
    </div>
  ...
  {isMenuOpen && (
    <div className="md:hidden bg-gray-900 bg-opacity-95">
      <div className="container mx-auto px-4 py-4 flex flex-col space-y-4">
        <a href="/" className="font-medium text-blue-400 block py-2 transition-all duration-300">
          Inicio
        </a>
        <a href="#soluciones" className="font-medium text-gray-300 hover:text-white block py-2 transition-all duration-300">
          Soluciones
        </a>
        <a href="#tecnologia" className="font-medium text-gray-300 hover:text-white block py-2 transition-all duration-300">
          Tecnología
        </a>
        
        {/* Sección de Políticas en mobile */}
        <div className="border-t border-gray-800 pt-2">
          <p className="text-gray-500 text-sm mb-2">Políticas</p>
          <a href="/policies" className="font-medium text-gray-300 hover:text-white block py-2 pl-4 transition-all duration-300">
            📋 Política de Privacidad
          </a>
          <a href="/policies-whatsapp" className="font-medium text-gray-300 hover:text-white block py-2 pl-4 transition-all duration-300">
            💬 Política WhatsApp
          </a>
        </div>
        
        <a href="#contacto" className="font-medium text-gray-300 hover:text-white block py-2 transition-all duration-300">
          Contacto
        </a>
      </div>
    </div>
  ...
  <div className="container mx-auto px-4">
    <div className="flex flex-col md:flex-row justify-between items-center">
      ...
      <div className="flex space-x-6 flex-wrap justify-center">
        <a href="/policies" className="text-gray-400 hover:text-white transition-colors duration-300">
          Política de Privacidad
        </a>
        <a href="/policies-whatsapp" className="text-gray-400 hover:text-white transition-colors duration-300">
          Política WhatsApp
        </a>
